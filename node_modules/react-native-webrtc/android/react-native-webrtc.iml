...
<module external.linked.project.id=":react-native-webrtc" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_8">
    ...
    <orderEntry type="library" name="Gradle: __local_aars__:./../node_modules/react-native-webrtc/android/libs/libjingle_peerconnection.so.jar:unspecified@jar" level="project" />
    <orderEntry type="library" name="Gradle: __local_aars__:./../node_modules/react-native-webrtc/android/libs/libwebrtc.jar:unspecified@jar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: com.facebook.react:react-native:0.61.5-jitsi.1@aar" level="project" />
